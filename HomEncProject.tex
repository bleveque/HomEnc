...
The main tool that could be used to break our multivariate encryption scheme above is the theory of \emph{Gr\"obner bases}. We defined the notion in section~\ref{sec:mv_security}, and now we give some intuition about their effectiveness in computation. Suppose we have a Gr\"obner basis for the ideal $(f,g) \in \Zxy$ at our disposal. 
...
Idea: get f.resultant(g,x) and f.resultant(g,y) to reduce encryptions by!~\cite{gentry-thesis}
