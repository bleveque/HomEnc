...
In an age of ubiquitous computing, digital security is an important aspect of everyday life. As computations become more expensive and time-consuming, and as the need for data storage increases, cloud computation is rising in popularity. With this rise comes the need for a new class of security protocols that can allow data to be stored in encrypted form yet manipulated in a meaningful way by third parties.

\subsection{Introduction to cryptographic concepts} 
Hello
